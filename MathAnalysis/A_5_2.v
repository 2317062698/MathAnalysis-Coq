...
Ltac QED_function := red; intros x21' y21' z21' Pq1 Pq2; 
  applyAxiomII' Pq1;
...
(* 定义复合函数 *)
Definition Comp (f g : Fun) := ∀(x u : R), x ∈ dom[g] /\ g[x] ∈ dom[f] /\ u = g[x] /\ (f ◦ g) [x] = f[u] 
  ...
  { split.
    ...
    - exists δ. split; auto. split.
      + intros x K1. destruct I1' as [u I1'].
        pose proof (H2 x u). destruct H13 as [H13[H14 [H15 [H16 [H17 H18]]]]].
